...
public class FabriqueBateau extends FabriqueVoyage {
	...
	public SegmentVoyage creerSegementVoyage(String code, Terminal origine, Terminal destination, Vehicule vehicule) {
		return new SegmentVoyage(code, origine, destination, vehicule);
	}
