package core.reservations.unites;

import core.voyage.ElementVoyage;
import core.reservations.unites.etats.Disponible;
import core.reservations.unites.etats.EtatUnite;
...
public class UniteReservable implements ElementVoyage {
	...
	public boolean isAvailable() {
		return etatActuel instanceof Disponible;
	}
